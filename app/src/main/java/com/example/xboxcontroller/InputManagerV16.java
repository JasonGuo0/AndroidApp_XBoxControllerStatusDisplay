...
public class InputManagerV16 implements InputManagerCompat {
    ...
    static class V16InputDeviceListener implements InputManager.InputDeviceListener {
        ...
        //No idea where this InputDeviceListen is from, from the InputManagerCompat interface?
        private V16InputDeviceListener(InputDeviceListener idl) {
            mIDL = idl;
        }
        @Override
    ...
    @Override
    public void onGenericMotionEvent(MotionEvent event) {} // unused in V16
}